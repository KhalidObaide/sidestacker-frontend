...
class Smart {
    static getValidMoves(board: CellState[][]): { direction: Direction; row: number }[] {
    ...
    static makeMove(board: CellState[][], move: { direction: Direction; row: number }, turn: Player ): CellState[][] {
        ...
        newBoard[move.row][column] = turn === Player.Player1 ? CellState.Player1 : CellState.Player2;
        return newBoard;
    }

    static minimax(board: CellState[][], depth: number, isMaximizing: boolean): number {
